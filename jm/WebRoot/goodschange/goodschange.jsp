	...
	$(document).ready(function(){ 
       ...
       $(document).ready(function(){ 
		$("#query").click(function(){
		    ...
		    dataType:"text",
		    success:function(json,status,xhr){ //处理成功(返回结果,状态,ajax操作对象)
			alert("添加成功");
			},
			error:function(xhr,err,exp){ //处理失败(ajax操作对象,错误,异常)
...
<body>
    <form id="form"  action="account.action" method="post">
        ...
        <input id="query" type="button" value="查询 " class="layui-btn layui-btn-normal"/>  <input type="reset" name="button" id="button" value="重置"  class="layui-btn layui-btn-normal"/><br/><br/>
        </div>
	    ...
	    <div class="layui-form-item" style="margin-left:40px">
        <input id="enter_submit" type="button" value="修改 " class="layui-btn layui-btn-normal"/>  <input type="reset" name="button" id="button" value="重置"  class="layui-btn layui-btn-normal"/><br/><br/>
